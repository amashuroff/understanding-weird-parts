...
- отделяем получение данных от их использования
...
- Declarative: декларативный, который нередко называют функциональным. При таком стиле программа выглядит как описание нужного результата, а не как набор инструкций. То есть программа отвечает на вопрос ЧТО («что мы хотим получить»)
...
- End to end: user behaviour
- Integration: verify that multiple units work together

-Unit: verify functionality of a single function/component
